...
public class InstructionsAdpater extends RecyclerView.Adapter<InstructionsViewHolder>{
    Context context;
    List<InstructionsResponse> list;

    public InstructionsAdpater(Context context, List<InstructionsResponse> list) {
