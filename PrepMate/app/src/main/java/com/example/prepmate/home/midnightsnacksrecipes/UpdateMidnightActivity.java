...
public class UpdateMidnightActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_midnight);
        ...
        update_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DatabaseHelper databaseHelper = new DatabaseHelper(UpdateMidnightActivity.this);
                ...
                databaseHelper.updateMidnightSnacksRecipe(id, userId, title, hours, minutes, ingredients, procedures);
    ...
    void confirmDialog(){
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                DatabaseHelper databaseHelper = new DatabaseHelper(UpdateMidnightActivity.this);
                databaseHelper.deleteMidnightSnacksRecipe(id, userId);
