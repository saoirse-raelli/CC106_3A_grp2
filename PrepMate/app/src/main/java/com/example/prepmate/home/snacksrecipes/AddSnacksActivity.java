...
public class AddSnacksActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_snacks);
        ...
        save_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DatabaseHelper databaseHelper = new DatabaseHelper(AddSnacksActivity.this);

                String hours = hours_input.getSelectedItem().toString();
                String minutes = minutes_input.getSelectedItem().toString();

                // Database method for adding snacks in the snacks_table
                databaseHelper.addSnacksRecipe(
